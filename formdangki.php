        ...
        <div class="card-body p-4">
            ...
            <form method="POST">
                <div class="mb-3">
                    ...
                    <select name="id_sukien" class="form-select" required>
                        ...
                        while($sk = $list_sk->fetch_assoc()) {
                            echo "<option value='".$sk['id']."'>".$sk['ten']."</option>";
                        }
                        ?>
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="masv" class="form-control" placeholder="Nhập mã số SV" required>
                </div>
                <div class="mb-3">
                ...
                <div class="d-grid mt-4">
                    ...
                    <a href="index.php" class="btn btn-link text-muted mt-2">Quay lại</a>
                </div>
            </form>
        </div>
    </div>
